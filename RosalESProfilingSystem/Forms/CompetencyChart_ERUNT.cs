...
{
    public partial class CompetencyChart_ERUNT: Form
    {
        ...
        public CompetencyChart_ERUNT(string year, string quarter)
        {
            InitializeComponent();
            selectedYear = year;
        ...
        private void LoadCompetencyData()
        {
            ...
            FROM ERUNTLearnerCompetencyProgress r 
            INNER JOIN ERUNTCompetencies c ON r.CompetencyId = c.CompetencyId
        ...
        private void CompetencyChart_ERUNT_Load(object sender, EventArgs e)
        {
            LoadCompetencyData();
        }
    }
